...
void MPU6050_setAccelXSelfTest(uint8_t enabled) {
    IICwriteBit(devAddr, MPU6050_RA_ACCEL_CONFIG, MPU6050_ACONFIG_XA_ST_BIT, enabled);
}
...
void MPU6050_setAccelYSelfTest(uint8_t enabled) {
    IICwriteBit(devAddr, MPU6050_RA_ACCEL_CONFIG, MPU6050_ACONFIG_YA_ST_BIT, enabled);
}
...
void MPU6050_setAccelZSelfTest(uint8_t enabled) {
    IICwriteBit(devAddr, MPU6050_RA_ACCEL_CONFIG, MPU6050_ACONFIG_ZA_ST_BIT, enabled);
}
...
void MPU6050_initialize(void) {
    ...
    MPU6050_setDLPFMode(MPU6050_DLPF_BW_98); //设置低通滤波器，98Hz
